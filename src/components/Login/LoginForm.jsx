...
import googleLogo from "./google_colour.svg";
import { UserEndpoints } from "../../api/user";
import { UserSignInData, UserSignUpData } from "../../api/user/user.interface";
...
const LoginForm = ({
  ...
  return (
    <>
      ...
      <div
        className="flex flex-col order-1 lg:order-none items-center lg:w-6/12 lg:justify-center lg:transform lg:scale-90">
        ...
        <button
          className="shadow-ds2 flex flex-row w-full lg:w-4/5 h-10 rounded-lg flex items-center justify-center leading-4 font-semibold font-inter text-sm mb-6">
          <NextImage
